...
public class AccountService {
    ...
    private final RedisTemplate<String, Object> redisTemplate; // redis 와 통신
    private HashOperations<String, String, Object> hashOperations; // redis에 저장할 hash 관련 객체 선언
    private static final String ACCOUNT_CACHE_KEY = "Account:"; // key의 접두사

    // 초기화
    @PostConstruct
    public void init() {
        this.hashOperations = redisTemplate.opsForHash(); // initialization
    }
    ...
    public CreateAccountResponseDto createAccount(CreateAccountRequestDto requestDto) {
        ...
        AccountDocument accountDocument = AccountDocument.builder()
                ...
                .nickname(savedAccount.getEmail())
    ...
    public AccountResponseDto updateAccount(Long accountId, BioUpdateRequestDto requestDto) {
        ...
        // redis에서 닉네임 업데이트(bio는 저장하지 않으므로 생략)
